                        ...
                        <div className="sign-content-rQn signin-content-rQn-margin-top">
                                ...
                                <div className="sign-form-footer-tQn">
                                    <div className="sign-form-error-vQ">
                                        {this.state.error.toSignIn._ &&
                                            <p className="sign-form-error-text-izL">{this.state.error.toSignIn.message}</p>  
                                        }
                                    </div>
                                    <div className="sign-footer-buttons-qH">
                                        <button className="sign-option-button-gQ inline" onClick={() => this.props.to(Routes.signUp)}>Create Account</button>
                            ...
                            <div className="sign-forget-password-container-bHg sign-container-style-yQnXoP">
                                <div className="sign-forget-password-content-iWc">
                                    <p className="sign-forget-password-text-tQ">You forget your password? <a href={`mailto:${Contact.support}`} className="sign-forget-password-contact-yQT">Contact us via email</a></p>
                                </div>
                            </div>
